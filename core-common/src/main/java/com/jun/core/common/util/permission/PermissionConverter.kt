...
object PermissionConverter {
    ...
    private val PERMISSION_NAME_MAP: MutableMap<String?, Int?> = HashMap<String?, Int?>()

    /** 权限描述映射（为了适配多语种，这里存储的是 StringId，而不是 String）  */
    private val PERMISSION_DESCRIPTION_MAP: MutableMap<Int?, Int?> = HashMap<Int?, Int?>()

    init {
        PERMISSION_NAME_MAP.put(PermissionGroups.STORAGE, R.string.common_permission_storage)
        PERMISSION_DESCRIPTION_MAP.put(
            R.string.common_permission_storage,
            R.string.common_permission_storage_description
        )

        PERMISSION_NAME_MAP.put(
            PermissionGroups.IMAGE_AND_VIDEO_MEDIA,
        ...
        PERMISSION_NAME_MAP.put(
            PermissionNames.READ_MEDIA_AUDIO,
            R.string.common_permission_music_and_audio
        )
        PERMISSION_DESCRIPTION_MAP.put(
            R.string.common_permission_music_and_audio,
        ...
        PERMISSION_DESCRIPTION_MAP.put(
            R.string.common_permission_microphone,
            R.string.common_permission_microphone_description
        )
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            ...
            PERMISSION_DESCRIPTION_MAP.put(
                ...
                R.string.common_permission_location_description
            )
        ...
        PERMISSION_DESCRIPTION_MAP.put(
            sensorsPermissionNameStringId,
            R.string.common_permission_body_sensors_description
        )
        ...
        PERMISSION_DESCRIPTION_MAP.put(
            ...
            R.string.common_permission_health_data_description
        )
        ...
        PERMISSION_DESCRIPTION_MAP.put(
            ...
            R.string.common_permission_call_logs_description
        )
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            ...
            PERMISSION_DESCRIPTION_MAP.put(
                ...
                R.string.common_permission_phone_description
            )
        } else {
        ...
        PERMISSION_DESCRIPTION_MAP.put(
            R.string.common_permission_contacts,
            R.string.common_permission_contacts_description
        )

        PERMISSION_NAME_MAP.put(PermissionGroups.CALENDAR, R.string.common_permission_calendar)
        PERMISSION_DESCRIPTION_MAP.put(
            R.string.common_permission_calendar,
            R.string.common_permission_calendar_description
        )
        ...
        PERMISSION_NAME_MAP.put(
            PermissionNames.ACTIVITY_RECOGNITION,
        ...
        PERMISSION_NAME_MAP.put(
            ...
            R.string.common_permission_access_media_location_information
        )
        PERMISSION_DESCRIPTION_MAP.put(
            R.string.common_permission_access_media_location_information,
        ...
        PERMISSION_DESCRIPTION_MAP.put(
            R.string.common_permission_sms,
            R.string.common_permission_sms_description
        )

        PERMISSION_NAME_MAP.put(
            PermissionNames.GET_INSTALLED_APPS,
            R.string.common_permission_get_installed_apps
        )
        PERMISSION_DESCRIPTION_MAP.put(
            R.string.common_permission_get_installed_apps,
        ...
        PERMISSION_NAME_MAP.put(
            ...
            R.string.common_permission_install_unknown_apps
        )
        PERMISSION_DESCRIPTION_MAP.put(
            R.string.common_permission_install_unknown_apps,
        ...
        PERMISSION_NAME_MAP.put(
            PermissionNames.SYSTEM_ALERT_WINDOW,
        ...
        PERMISSION_NAME_MAP.put(
            PermissionNames.WRITE_SETTINGS,
        ...
        PERMISSION_NAME_MAP.put(
            PermissionNames.NOTIFICATION_SERVICE,
            R.string.common_permission_allow_notifications
        )
        PERMISSION_DESCRIPTION_MAP.put(
            R.string.common_permission_allow_notifications,
        ...
        PERMISSION_NAME_MAP.put(
            PermissionNames.BIND_NOTIFICATION_LISTENER_SERVICE,
        ...
        PERMISSION_NAME_MAP.put(
            PermissionNames.PACKAGE_USAGE_STATS,
        ...
        PERMISSION_NAME_MAP.put(
            PermissionNames.SCHEDULE_EXACT_ALARM,
            R.string.common_permission_alarms_reminders
        )
        PERMISSION_DESCRIPTION_MAP.put(
            R.string.common_permission_alarms_reminders,
        ...
        PERMISSION_NAME_MAP.put(
            PermissionNames.ACCESS_NOTIFICATION_POLICY,
            R.string.common_permission_do_not_disturb_access
        )
        PERMISSION_DESCRIPTION_MAP.put(
            R.string.common_permission_do_not_disturb_access,
        ...
        PERMISSION_NAME_MAP.put(
            PermissionNames.REQUEST_IGNORE_BATTERY_OPTIMIZATIONS,
        ...
        PERMISSION_DESCRIPTION_MAP.put(
            R.string.common_permission_vpn,
            R.string.common_permission_vpn_description
        )

        PERMISSION_NAME_MAP.put(
            PermissionNames.PICTURE_IN_PICTURE,
            R.string.common_permission_picture_in_picture
        )
        PERMISSION_DESCRIPTION_MAP.put(
            R.string.common_permission_picture_in_picture,
        ...
        PERMISSION_NAME_MAP.put(
            PermissionNames.USE_FULL_SCREEN_INTENT,
            R.string.common_permission_full_screen_notifications
        )
        PERMISSION_DESCRIPTION_MAP.put(
            R.string.common_permission_full_screen_notifications,
        ...
        PERMISSION_NAME_MAP.put(
            PermissionNames.BIND_DEVICE_ADMIN,
            R.string.common_permission_device_admin
        )
        PERMISSION_DESCRIPTION_MAP.put(
            R.string.common_permission_device_admin,
            R.string.common_permission_device_admin_description
        )

        PERMISSION_NAME_MAP.put(
            PermissionNames.BIND_ACCESSIBILITY_SERVICE,
            R.string.common_permission_accessibility_service
        )
        PERMISSION_DESCRIPTION_MAP.put(
            R.string.common_permission_accessibility_service,
        ...
        PERMISSION_NAME_MAP.put(
            PermissionNames.MANAGE_MEDIA,
            R.string.common_permission_manage_media
        )
        PERMISSION_DESCRIPTION_MAP.put(
            R.string.common_permission_manage_media,
            R.string.common_permission_manage_media_description
        )
    }
    ...
    fun getNickNameListByPermissions(
        ...
        val permissionNickNameList: MutableList<String?> = ArrayList<String?>()
    ...
    fun getDescriptionListByPermissions(
        ...
        val descriptionList: MutableList<String?> = ArrayList<String?>()
        for (permission in permissions) {
    ...
    fun getPermissionNickNameStringId(context: Context, permission: IPermission): Int? {
        ...
        val permissionNameStringId = PERMISSION_NAME_MAP.get(permissionName)
        if (permissionNameStringId != null && permissionNameStringId > 0) {
            return permissionNameStringId
        }
        val permissionGroupStringId = PERMISSION_NAME_MAP.get(permissionGroup)
